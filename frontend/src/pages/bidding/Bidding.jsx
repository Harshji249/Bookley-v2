...
import { addproduct } from "./BiddingSlice";
            ...
            <Container maxWidth={false} sx={{ backgroundImage: `url(${group})`, backgroundRepeat: "no-repeat", backgroundPosition: "0 0", overflowX: "hidden" }}>
                ...
                <Box sx={{ height:"100vh",width:"100vw",backgroundImage: `url(${group2})`, backgroundRepeat: "no-repeat", backgroundPosition: "75rem 14rem",}}>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-evenly" }}>
                        <Box sx={{ my: 15, ml: 25 }}>
                            <Typography variant='h2' sx={{ fontFamily: "Jost", }} >Start Your Bidding</Typography>
                            <Box >
                                <form onSubmit={handleSubmit} >
                                    ...
                                    <Box sx={{ my: 2 }}>
                                        ...
                                        <TextField autoComplete='off' sx={{ width: 300 }} id="outlined-basic" label="Starting Bid" variant="outlined" name="price"
                                    ...
                                    <Button type="submit" variant="contained" sx={{ fontFamily: "Jost", my: 3, mr: 15, width: "10rem", height: "2rem" }}>Start Your Bid</Button>
                                </form>
                            </Box>
                        </Box>
                        <Box sx={{ display: "flex" }}>
